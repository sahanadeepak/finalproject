...
public class capture_speech extends Activity{
	TextToSpeech t1;
	...
	@Override
	   protected void onCreate(Bundle savedInstanceState) {
	      ...
	      setContentView(R.layout.capture_speech);
	 			...
	 			}catch(Exception e)
	 			{
					...
					//	String encPass=ae.encrypt(pass);
                    	...
                    	String response = null;
		            	   ...
		            	   response = CustomHttpClient.executeHttpPost(Global.url+"capture_speech", postParameters);
		            	  ...
		            	  res= res.replaceAll("\\s+","");   //removing spaces in between the words    
		            	   ...
		            	   Toast.makeText(getApplicationContext(), "User ID is"+res, Toast.LENGTH_LONG).show();
			         		...
			         		if(res.equals("ok"))
			         		{
			         			...
			         			Intent next =new Intent(this,color_password.class);
			         			startActivity(next);
			         		}
